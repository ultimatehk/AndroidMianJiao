...
/**
 * Subclass of {@link android.support.v4.app.ListFragment} which provides automatic support for providing the
 * 'swipe-to-refresh' UX gesture by wrapping the the content view in a
...
public class BaseSwipeRefreshListFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mSwipeRefreshLayout.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
				ViewGroup.LayoutParams.MATCH_PARENT));
		// 可以更换colorScheme
		mSwipeRefreshLayout.setColorSchemeResources(R.color.default_blue, R.color.default_light_blue);
		// Now return the SwipeRefreshLayout as this fragment's content view
		return mSwipeRefreshLayout;
	}

	/**
	 * Set the {@link android.support.v4.widget.SwipeRefreshLayout.OnRefreshListener} to listen for initiated refreshes.
	 *
	...
	/**
	 * Returns whether the {@link android.support.v4.widget.SwipeRefreshLayout} is currently refreshing or not.
	 *
	...
	/**
	 * Set whether the {@link android.support.v4.widget.SwipeRefreshLayout} should be displaying that it is refreshing
	 * or not.
	 *
	 ...
	 * {@link android.support.v4.widget.SwipeRefreshLayout} only supports a single child, which it expects to be the one
	 * which triggers refreshes. In our case the layout's child is the content view returned from
	 * {@link android.support.v4.app.ListFragment#onCreateView(android.view.LayoutInflater, android.view.ViewGroup, android.os.Bundle)}
	 * which is a {@link android.view.ViewGroup}.
	 *
	 * <p>
	 * To enable 'swipe-to-refresh' support via the {@link android.widget.ListView} we need to override the default
	 * behavior and properly signal when a gesture is possible. This is done by overriding {@link #canChildScrollUp()}.
	 */
